...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, src,
                mask: Optional[Tensor] = None,  # mask is None
                src_key_padding_mask: Optional[Tensor] = None,
                pos: Optional[Tensor] = None):
        # src: [h*w, b, hidden_dim], the outputs of the last layer
        # pos: [H*w, b, c], the position encoding of the last layer
        # src_key_padding_mask: [b, h*w], the mask of the last layer
        output = src
